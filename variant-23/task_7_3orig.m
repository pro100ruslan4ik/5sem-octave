...
function value_of_integral = symbolic_integration
    ...
    syms rho theta phi
    syms pi
    f_cartesian = 1 / sqrt((x^2 + y^2 + z^2)^3)
...
function value_of_integral = numeric_integration
    ...
    value_of_integral = quadgk(@(rho) integrate_theta(rho), 1e-10, 2)
endfunction
